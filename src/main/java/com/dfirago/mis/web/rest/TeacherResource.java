...
public class TeacherResource {
    ...
    @RequestMapping(value = "/teachers/{id}/timetable",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<TimetableResponseDTO> getTimetableForTeacher(@PathVariable Long id, @Valid @RequestBody TimetableRequestDTO request) throws URISyntaxException {
        ...
        TimetableResponseDTO response = timetableService
            .generateTimetableForTeacher(id, from, to);
